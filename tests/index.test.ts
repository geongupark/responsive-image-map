...
describe('makeResponsiveImageMap', () => {
  ...
  it('should resize map coordinates correctly', () => {
    ...
    const image1 = document.querySelector<HTMLImageElement>('.class1')!;
    const image2 = document.querySelector<HTMLImageElement>('.class2')!;
    ...
    const area1 = document.querySelector<HTMLAreaElement>('map[name="image-map-1"] area')!;
    const area2 = document.querySelector<HTMLAreaElement>('map[name="image-map-2"] area')!;
